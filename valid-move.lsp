	...
	(let ((spot position)
		...
		(cond
			((string= color "W")
				(when (string= (nth (1- spot) *board*) "B")
					...
					(if (can-flip copyboard spot color "W" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (- spot 11) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "NW" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (- spot 10) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "N" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (- spot 9) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "NE" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (1+ spot) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "E" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (+ spot 11) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "SE" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (+ spot 10) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "S" 1) (flip-pieces spot color))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (+ spot 9) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip copyboard spot color "SW" 1) (flip-pieces spot color))
				)
			)
