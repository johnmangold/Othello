	...
	(let ((spot position))
		...
		(cond
			((string= color "W")
				(when (string= (nth (- spot 11) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "NW" 1) (flip-pieces spot color "NW" 1))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (- spot 10) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "N" 1) (flip-pieces spot color "N" 1))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (- spot 9) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "NE" 1) (flip-pieces spot color "NE" 1))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (1+ spot) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "E" 1) (flip-pieces spot color "E" 1))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (+ spot 11) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "SE" 1) (flip-pieces spot color "SE" 1))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (+ spot 10) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "S" 1) (flip-pieces spot color "S" 1))
				)
			)
		...
		(cond
			((string= color "W")
				(when (string= (nth (+ spot 9) *board*) "B")
					; if flips can be made flip pieces
					(if (can-flip (copy-list *board*) spot color "SW" 1) (flip-pieces spot color "SW" 1))
				)
			)
