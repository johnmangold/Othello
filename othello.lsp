					...
					(cond
						((equal (mod turncount 2) 0)
							(cond ((and (null (move-generator *board* "W")) (null (move-generator *board* "B"))) 
									...
									(cond ((> bcount wcount) 
												(print-board) 
												(format t "Black Wins! ~a - ~a" bcount wcount))
										  (t 
										  (print-board) 
										  (format t "White Wins! ~a - ~a" wcount bcount))
									)
									(return)
								  )
							)
						...
						(t 
							(cond ((and (null (move-generator *board* "W")) (null (move-generator *board* "B"))) 
									...
									(cond ((> bcount wcount) (print-board) (format t "Black Wins! ~a - ~a" bcount wcount))
										  (t (print-board)  (format t "White Wins! ~a - ~a" wcount bcount))
									)
									(return)
								  )
							)
